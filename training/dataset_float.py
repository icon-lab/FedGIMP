...
######################################################################################################################################################################
#DATASET CLASS TO LOAD FROM FLOAT TYPE TFRECORDS FILES
...
class TFRecordDataset:
    ...
    def parse_tfrecord_tf(record):
        features = tf.compat.v1.parse_single_example(record, features={
            ...
            'data': tf.compat.v1.FixedLenSequenceFeature([3,], tf.float32, allow_missing=True,default_value=0.0)})
...
def load_dataset(class_name='training.dataset_float.TFRecordDataset', data_dir=None, verbose=False, max_label_size=None, repeat = True, shuffle_mb=4096):
